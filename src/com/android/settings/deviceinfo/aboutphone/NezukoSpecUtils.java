...
public class NezukoSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String NEZUKO_CPU_MODEL_PROPERTY = "ro.nezuko.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelNezuko = SystemProperties.get(NEZUKO_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelNezuko.isEmpty()) {
            return cpuModelNezuko;
